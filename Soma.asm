...
section .data
    ...
    msgSoma16    db      "=========== Soma de 16 bits ===========",0xA, 0
    size_msgSoma16   equ     $-msgSoma16

    msgSoma32    db      "=========== Soma de 32 bits ===========",0xA, 0
    size_msgSoma32   equ     $-msgSoma32
...
_SOMA16:
    ...
    ; Realizar a Soma N2 = N1 + N2
    pop     ebx             ; pega o primeiro numero
    add     eax, ebx        ; soma os dois numeros

    ; Transformar o resultado para string
    push    eax             ; push eax (resultado da soma)
